const BandsInfo = [
    ...
    },
    {
        ...
        name:"Change",
        time: '5:30 pm',
        description:'Change is a dreamy pop band blending ethereal vocals, nostalgic melodies, and ambient textures to create a soundscape that feels like a lucid dream. Rooted in emotion and atmosphere, their music drifts between melancholy and hope.',
    ...
    }, 
    {
        ...
        name: 'Madness', 
        time: '4:00 pm', 
        description : "Madناس, a band founded in 2022 by Mouhammed Amin Dridi and Islem Hamrouni, dances beyond the bounds of genre. Their music flows like emotion itself ,shifting with the seasons of the soul. For to them, music is no formula, but a living echo of the human experience—ever-changing, ever-true.A journey without borders,where sound follows heart,and beauty lies in the honest expression of being a human in this modern world", 
        image:'../images/Madness.png' , 
        instagram: 'https://www.instagram.com/mad_ness_band/' ,
    },
    {
        id:'5',
        name:'CineRadio Band' , 
    ...
    }, 
    {
        ...
        name:'C*p Cake' , 
        time:'6:30 pm' , 
        description : "C*pcake is a group of students from Tunisia that bring raw energy and emotion to every performance. We are heavily loaded with sounds, powerful vocals, and a driving rhythm section, and we rock hard-hitting covers and originals that deliver the same power.", 
        image: '../images/CupCake.png' , 
        instagram:'https://www.instagram.com/cxpcake.band/' ,
    }, 
    {
        id:'7',
        name: 'Rain In Space', 
